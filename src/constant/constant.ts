...
export const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    text:
      "Black Moon helped us grow faster than we expected. Their strategies are smart, their designs are beautiful, and their process is seamless. We finally feel confident about our social media.",
  ...
  },
  {
    ...
    text:
      "Partnering with Black Moon has been a game changer for us. Our social media strategy used to feel messy and directionless. Their team came in, cleaned everything up, and built a strong structure that works. Every deliverable is on time and every idea is backed by research and data. Their communication is smooth and their creativity feels authentic. They made it easy for us to focus on running our business while knowing our brand is growing online.",
  ...
  },
  {
    ...
    text:
      "Working with Black Moon feels easy and natural. They listen, they plan, and they execute with precision. What I love most is how every campaign feels personal to our brand, not copied from someone else.",
  ...
  },
  {
    ...
    text:
      "Before we found Black Moon, our campaigns were inconsistent and unpredictable. Since working with them, everything feels organized and purposeful. They pay attention to what works and what does not, then adjust fast. Within one quarter, our reach increased by more than 150 percent and our followers became more engaged. They are data-driven but still creative, which makes them the perfect mix of strategy and emotion.",
  ...
  },
  {
    ...
    text:
      "Black Moon is not just another agency. They are genuine partners who care about long-term results. From our first meeting, we could tell they were invested in helping us grow. They built a full marketing system that connects our content, ads, and leads together. Their reports are easy to understand and always show clear progress. Our revenue and visibility have both improved steadily. It feels good knowing our brand is in the hands of people who truly care.",
  ...
  },
  {
    ...
    text:
      "Black Moon helped us bring structure and strategy to our content. Their team is organized, creative, and always one step ahead. We’ve seen real growth in engagement and brand visibility since partnering with them.",
