  ...
  return (
    <section className='pt-20 pb-20 overflow-x-clip'>
        <div className='container mx-auto px-4 md:px-6 lg:px-8'>
            ...
            <div className='flex flex-col items-center'>
            <span className='font-[family-name:var(--font-orbitron)] text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl text-center font-black pb-5'>We don't just spot trends,<br /> we spark them</span>
       ...
       <MaskedDiv  maskType="type-4" className="my-4">
        ...
        >
         <source
            src="https://files.catbox.moe/j0enaw.mp4"
            type="video/mp4"
          />
        </video>
      </MaskedDiv>
