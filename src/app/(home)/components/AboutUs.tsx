                        ...
                        >
                            ...
                            >
                                <Image
                                    ...
                                    alt="Angella Bituin - CEO of Black Moon"
                                    width={500}
                                    height={500}
                                    priority
                                />
                            ...
                            >
                                ...
                                >
                                    <p className='text-base md:text-lg text-gray-700 dark:text-gray-300 leading-relaxed'>
                                        At Black Moon, we don’t just craft strategies. We build end-to-end digital systems that work, so you can rest easy knowing your growth is always in motion.
                                    </p>
                                    
                                    <p className='text-base md:text-lg text-gray-700 dark:text-gray-300 leading-relaxed'>
                                        We blend creativity, psychology, and data to deliver a first-class experience that feels less like outsourcing and more like having your own in-house digital marketing team.
                                    </p>
                                </motion.div>
